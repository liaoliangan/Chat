...
void TcpMgr::initHandlers()
{
    ...
    _handlers.insert(LA::ReqId::ID_AUTH_FRIEND_RSP, [this](LA::ReqId id, int len, QByteArray data)
    {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
    ...
    _handlers.insert(LA::ReqId::ID_NOTIFY_AUTH_FRIEND_REQ, [this](LA::ReqId id, int len, QByteArray data)
    {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
